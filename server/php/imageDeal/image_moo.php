...
class Image_moo
{
    ...
    //----------------------------------------------------------------------------------------------------------
    {
        ...
        if ($image_info){
            ...
            $this->set_error('Unable to load '.$filename.' filetype '.$extPart.' not supported');
            return FALSE;
        }
    }
    ...
    public function resizeToWidth($dstWidth)
    {
        $dstHeight = $dstWidth * ($this->height/$this->width) ;
        return $this->resize_crop($dstWidth,$dstHeight);
    }
