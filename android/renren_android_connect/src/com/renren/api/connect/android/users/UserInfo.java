...
public class UserInfo {
    ...
    public UserInfo parse(JSONObject object) throws RenrenException {
        ...
        if (homeTownLocation == null){
        	JSONObject jsonObjHomeTown = object.optJSONObject(KEY_HOMETOWN_LOCATION);
        	JSONArray jsonAryHomeTown = new JSONArray();
        	jsonAryHomeTown.put(jsonObjHomeTown);
        	homeTownLocation = HomeTownLocation.parse(jsonAryHomeTown);
        }
