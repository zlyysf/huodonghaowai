package com.lingzhimobile.tongqu.asyncloader;
...
public class GetNearbyDateLoader extends AsyncTaskLoader<List<DateListItem>> {
    ...
    public GetNearbyDateLoader(Context context) {
        super(context);
    }

    public GetNearbyDateLoader(Context context, String userId, long cutOffTime,
            int count, int start) {
        super(context);
        this.userId = userId;
        this.count = count;
