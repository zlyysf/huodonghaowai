    ...
    public void LoadOriginalImage() {
        if (getPi() != null) {
            ...
            if (bitmap != null) {
                ...
                pi.getPostBitmapAsync(new com.lingzhimobile.tongqu.util.MethodHandler<Bitmap>() {
    ...
    public void LoadImage() {
        if (getPi() != null) {
            ...
            if (bitmap != null) {
                ...
                pi.getFwPostBitmapAsync(new com.lingzhimobile.tongqu.util.MethodHandler<Bitmap>() {
                    public void process(Bitmap para) {
                        Message msg = viewHandler.obtainMessage(getId(),
                                FlowView.this);
                        msg.getData().putString("dataType", dataType);
